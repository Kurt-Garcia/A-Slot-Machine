...
<?php include('wholesale_modal.php'); ?>
...
<div class="customer-content">
    ...
    <?php
        ...
        {
        ?>
            <span class="text-danger" style="font-size: 1.4rem;">Note : The amount needed to avail GCAP-Slots is atleast ₱<?php echo $fetch['amount']; ?> and up.</span>
    ...
    <div class="container-box">
        <form action="check_invoice.php" method = "POST">
            <div class="input-content">
             ...
             <button type="button" id="btn-wholesale" class="btn btn-success btn-lg float-end" data-bs-toggle="modal" data-bs-target="#wholesaleModal">WHOLESALE</button>
