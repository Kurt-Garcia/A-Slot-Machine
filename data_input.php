            ...
            <div class="modal-dialog modal-m">
                ...
                <form id="modal_add">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid" style='padding-top: 20px; padding-bottom: px; width:100%; '>
                            <div class='container'>

                            <div class = "row" style=' margin-top: 20px; margin: 0 auto; display: flex; justify-content: center;  align-items: center;'>
                                <div class="col-sm-4">
                                    <div class="form-group row">
                                        <label for="sel1" style =" font-size: 15px;  color: #cccccc; margin-top: -15px; " > No of Spins: </label> 
                                    </div>
                                </div>     
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group row">
                                        ...
                                        <select type="text2" style="width:100%; text-align: left; background-color:#676767;color:#fff; padding: 6px 10px; border-radius: 8px; " name="ticketno" id="ticketno" autocomplete="off" aria-describedby="basic-addon2"  >
                            ...
                            <div class='row' style='margin-top: 0px; margin: 0 auto; display: flex; justify-content: center;  align-items: center;'>
                                    
                                <div class='col-sm-4'>  
                                    <div class='form-group row'>
                                                
                                            <label style ='padding-top: 5px; color: #cccccc; font-size: 15px; text-align: right; '>Counter:</label>
                            ...
                            <div class='row' style='margin-bottom: px; margin: 0 auto; display: flex; justify-content: center;  align-items: center;'>
                                    ...
                                    <div class='form-group row'>
                                        ...
                                        <input type='text' class='form-control' id='orno1' name='orno1'  style ='width: 100%;'  autocomplete='off'  onInput='checkUsername()' onkeypress='return onlyNumberKey(event)'  required disabled >
                            ...
                            <div class='row' style=' margin: 0 auto; display: flex; justify-content: center;  align-items: center;'> 
                                    ...
                                    <div class='form-group row'>
                                        ...
                                        <span id='check-username' style='margin-bottom: -30px'></span> 
                                        <span id='check-username2'style='margin-bottom: -30px'></span>
                            ...
                            <div class='row' style=' margin-top: 5px; margin: 0 auto; display: flex; justify-content: center;  align-items: center;'> 
                            
                                    <div class='col-sm-4'>  
                                    <div class='form-group row'>
                                                
                                          
                                        <button type='submit'  class='btn btn-primary' id='submit_add' style='color:#fff; border-radius: 8px; margin-top: 30px; margin-bottom: -15px;' 
    ...
    <table class="table table-striped" id="mydatatable">
        ...
        <thead>
            <tr>
                ...
                <th>Inv No</th>
                <th class='hide-column'>Amount</th>
                <th>Spin</th>
                <th>Status</th>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <?php 
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<td class='hide-column'> " . $row["name"] . " </td>";
                    echo "<td class='hide-column'> " . $row["address"] . " </td>";
                    echo "<td> " . $row["orno"] . " </td>";
                    echo "<td class='hide-column'> " . $row["amount"] . " </td>";
