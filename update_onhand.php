...
$query_onhand           ="UPDATE win_prizes SET onhand='$onhand_total_2ndx', won='$onhand_won_2ndx' where item='$onhand_item_2ndx'"; 
...
if ($result_max_spin) {
    ...
    $save_win = "INSERT INTO win_result (name, orno, spin_no, result, prize, date) 
                 VALUES ('$cust_name_win', '$cust_or_win', '$new_spin_no', 'Win', '$onhand_item_2ndx', '$cust_date')";
