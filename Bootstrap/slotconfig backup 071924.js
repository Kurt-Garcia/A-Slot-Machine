...
function doSlot(){
	...
	doing = true;
	var numChanges = randomInt(1,4)*17
	var numeberSlot1 = numChanges+randomInt(1,17)
	var numeberSlot2 = numChanges+2*7+randomInt(1,17)
	var numeberSlot3 = numChanges+4*7+randomInt(1,17)
