...
var currentDate = new Date($('#currentDateTime').html());
var targetDate = new Date("5/8/2024, 10:10:00 AM");

//let refreshIntervalId;//refresh page
	...
	if (((slot1 == slot2 && slot2 == slot3)))
		...
		(slot2 == slot3 && slot2 == "a6") ) && !(slot1 == slot2 && slot2 == slot3 && slot1=="a6"))
		{
			...
			$.ajax({
				...
				type: "POST",
				data: { onhand_totals_2ndxxx: onhand_total_2ndxxx, onhand_items_2ndxxx: onhand_item_2ndxxx, onhand_won_2ndxxx: onhand_won_2ndxxx },
				success: function(response) {
					// Handle success, if needed
					// alert(onhand_total_2ndxxx);
				},
