...
<script>
    $(document).ready(function(){
      ...
      function showValues() {
          ...
          $.post('search_ticket.php',  { ticketno: form11.ticketno.value, presdate: form11.presdate.value, player_no: form11.player_no.value },
...
<div class="box" style="border: 1px solid #cccccc; padding: 20px; margin: 25px auto; border-radius: 15px; width: 84%;  background-color: #484848; margin-top:-10px;">
  
    <div class="container-fluid" style="width:100%; margin-top:-10px;">
        <div class='float-sm' >
            <div>
                  <h3 align="left" style="font-weight: bold; font-size: 20px; color: #cccccc; margin-left: 0px; margin-bottom: 20px">PLAYERS DATA </h3>
            </div>
        </div>
    </div>
        ...
        <form name="form11" >
            <div class = "row" style='margin-bottom:-10px; margin-top:10px;'>
                ...
                <?php
                    ...
                    $query_playerno             = "SELECT * FROM customer WHERE status='1' AND date >' $datecurrent' ORDER BY date DESC LIMIT 1";
                    $result_playerno            = mysqli_query($conn,$query_playerno);
                    $fetch_playerno             = mysqli_fetch_array($result_playerno);
                    ...
                    if($fetch_playerno<1) {
                        ...
                        $cust_playerno          = $fetch_playerno['player_no'];
                        $cust_playerno ++;
                        $cust_playerno_1        = $cust_playerno;
                ...
                <div class="col-sm">   
                    <div class="form-group row" >
                        ...
                        <input type="text" class="form-control" id="player_no" name ="player_no" style="width:100%;" value="<?php echo $cust_playerno_1; ?>" hidden>
        ...
        <div class = "row">
            ...
            <div class='col-sm-6' >
                <div class="form-group row">
                    ...
                    <h3 align="left" style="font-weight: bold;  font-size: 20px; color: black; margin-bottom:-5px;"> TOTAL PLAYER FOR TODAY &nbsp&nbsp <?php 
