...
<div class='row'>
      ...
      <div class='col-sm-4'>
        <div class='form-group row'>
             ...
             <input type='text' class='form-control' id='name' name='name'  style ='width: 100%; font-size: 15px;background-color:#676767;color:#cccccc;border-color: #676767; border-radius: 8px ;' autocomplete='off'>
      ...
      <div class='col-sm-1'> 
       ...
       <div class='col-sm'>  
        <div class='form-group row'>
             ...
             <input type='text' class='form-control' id='celno' name='celno'  style ='width: 100%; font-size: 15px; background-color:#676767;color:#cccccc;border-color: #676767; border-radius: 8px ;'  onkeypress='return onlyNumberKey(event)'  autocomplete='off'>
    ...
    <div class='row' style='margin-bottom:-21px;'>
      ...
      <div class='col-sm'>   
        <div class='form-group row'> 
               ...
               <input type='text' style='width:75%; background-color:#676767;color:#cccccc;border-color: #676767; border-radius: 8px ; ' class='form-control' id='address' name='address' autocomplete='off'>
...
<div class='row' style='margin-bottom: px;'>
      ...
      <div class='col-sm-4'>  
        <div class='form-group row'>
             ...
             <label style ='padding-top: 5px;font-size: 12px;'> </label>
    ...
    <div class='row'>
      ...
      <div class='col-sm-4'>  
        <div class='form-group row'>
            ...
            <input type='text' class='form-control' id='orno1' name='orno1'  style ='width: 100%; font-size: 15px; background-color:#676767;color:#cccccc;border-color: #676767; border-radius: 8px ;' autocomplete='off'  onInput='checkUsername()' onkeypress='return onlyNumberKey(event)' disabled >
...
&nbsp&nbsp
      ...
      <div class='col-sm-2'>  
       <div class='form-group row'>
             ...
             <input type='text' class='form-control' id='amount1' name='amount1'  style ='width: 100%; font-size: 15px; background-color:#676767;color:#cccccc;border-color: #676767; border-radius: 8px ;' autocomplete='off' onkeypress='return onlyNumberKey(event)' disabled>
...
&nbsp&nbsp
      ...
      <div class='col-sm'>  
       <div class='form-group row'>
             ...
             <input type='number' class='form-control' id='ctr1' name='ctr1'  style ='width: 100%; font-size: 15px; background-color:#676767;color:#cccccc;border-color: #676767; border-radius: 8px ;' autocomplete='off'  onInput='checkUsername()'>
    ...
    <div class='row' style='margin-bottom:-30px; margin-top:-5px; margin-right: 10px;'>
        <div class='col-sm' style='display: flex; justify-content: flex-end'>
            <div class='form-group row'> 
                 ...
                 <button type='submit'  class='btn btn-primary' name='btn_submit' id='submit' style='color:#fff; border-radius: 8px; margin-right: -10px;' onclick='return confirm_save()'  tabindex='3' disabled> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Save &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>
